...
# PSScriptAnalyzer (PSAvoidUsingWriteHost) discourages Write-Host: it cannot be redirected,
# suppressed or captured. Write-Information carries the same text through the information
# stream, with colour applied via $PSStyle on hosts that support it.
